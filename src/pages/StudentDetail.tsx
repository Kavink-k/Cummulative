          ...
          <CardHeader className="bg-gradient-to-r from-primary/5 to-accent/5">
            <div className="flex items-start justify-between">
              ...
              {student.steps.step1?.photoUrl && (
                <div className="ml-4">
                  <img
                    src={student.steps.step1.photoUrl.startsWith('http') ? student.steps.step1.photoUrl : `https://cummulative-backend-production.up.railway.app${student.steps.step1.photoUrl}`}
                    alt={student.name}
              ...
              <div className="flex gap-6">
                ...
                <div className="flex-shrink-0">
                  <img
                    src={
                      student.steps.step1?.photoUrl
                        ? (student.steps.step1.photoUrl.startsWith('http') ? student.steps.step1.photoUrl : `https://cummulative-backend-production.up.railway.app${student.steps.step1.photoUrl}`)
